...
export const metadata: Metadata = {
  ...
  keywords: 'social media marketing, social media campaigns, audience engagement, content creation, paid social ads',
  authors: [{ name: 'Terzettoo' }],
  openGraph: {
    title: 'Social Media Marketing Services | Terzettoo',
    description: 'Tailored social media strategies to maximize your brand’s reach and engagement.',
    url: 'https://terzettoo.com/social-media-marketing',
    siteName: 'Terzettoo',
    locale: 'en_US',
    type: 'website',
  },
  alternates: {
    canonical: 'https://terzettoo.com/social-media-marketing',
  },
}
