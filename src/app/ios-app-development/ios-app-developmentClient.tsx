...
const iosAppDevelopmentContent: ServiceContent = {
  hero: {
    title: 'iOS App Development',
    subtitle: 'High-Quality iPhone & iPad Apps',
  ...
  features: {
    title: 'iOS App Development Features',
    items: [
      {
        icon: Code,
      ...
      },
      {
        ...
        description: 'Support for all iPhone and iPad models.'
      },
      {
        icon: Users,
  ...
  writtenContent: {
    ...
    facts: [
      { label: 'Apps Delivered', value: '90+' },
      { label: 'Satisfied Clients', value: '95%' },
      { label: 'iOS Experts', value: '20+' },
...
export default function IosAppDevelopmentClient() {
  return <ServicePageTemplate content={iosAppDevelopmentContent} />
}
