...
export const metadata: Metadata = {
  ...
  description: 'End-to-end data analytics solutions including data collection, visualization, predictive modeling, and big data processing with Terzettoo.',
  ...
  openGraph: {
    ...
    url: 'https://www.terzettoo.com/data-analytics',
    siteName: 'Terzettoo',
    locale: 'en_US',
    type: 'website',
  },
  alternates: {
    canonical: 'https://www.terzettoo.com/data-analytics',
  },
}
