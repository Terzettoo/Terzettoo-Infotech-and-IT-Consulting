...
export const metadata: Metadata = {
  ...
  description: 'Custom iPad app development services delivering high-performance, user-friendly applications for all iPad models.',
  keywords: 'iPad app development, iPad apps, Swift development, Objective-C development, mobile app development',
  ...
  openGraph: {
    ...
    url: 'https://terzettoo.com/ipad-app-development',
    siteName: 'Terzettoo',
    locale: 'en_US',
    type: 'website',
  },
  alternates: {
    canonical: 'https://terzettoo.com/ipad-app-development',
  },
}
