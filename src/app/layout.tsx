  ...
  return (
    <html lang="en" className="scroll-smooth">
      <head>
        ...
        {/* Meta Pixel (Facebook Pixel) - Using dangerouslySetInnerHTML for reliable execution */}
        <script
          dangerouslySetInnerHTML={{
            __html: `
        ...
        <noscript
          dangerouslySetInnerHTML={{
            __html: `<img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=1256998902924411&ev=PageView&noscript=1" />`,
          }}
        />
      </head>
