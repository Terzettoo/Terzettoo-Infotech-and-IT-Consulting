...
export const metadata: Metadata = {
  title: 'Privacy Policy - Scrubb | Terzettoo',
  description: 'Privacy Policy for Scrubb: Apple 5.1.1 Delete Shopify App',
}
    ...
    <div className="min-h-screen bg-white text-[#2b2d42]">
      <header className="bg-[#d90429] mt-16 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl !text-white md:text-4xl font-bold">Privacy Policy - Scrubb</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-red max-w-4xl mx-auto">
          <section className="mb-12">
            ...
            <p>
              At Terzettoo, we believe in minimizing data footprints. When you install <strong>Scrubb: Apple 5.1.1 Delete</strong>, we only store your store&apos;s <code>shop_domain</code> and an OAuth <code>access_token</code> in a secure, local SQLite database strictly to authenticate API calls. 
            </p>
            <p>
          ...
          <section className="mb-12">
            ...
            <p>
              We believe apps should clean up after themselves. When a merchant uninstalls Scrubb from their Shopify admin, we automatically delete their OAuth access token and shop data from our database within 48 hours via the mandatory <code>app/uninstalled</code> webhook.
            </p>
          </section>
